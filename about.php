...
<body>
  <?php 
    include 'menu.php';
?>
  <section class="section about1" style="order: 1; height: 100vh;
    ...
    padding-bottom: 15px;">
        <p style="text-transform: none; padding: 0 8.8vw 0.5vw 8.8vw;">
  ...
  <div style="order: 2; height: inherit;
    width: 100%; display: flex; flex-direction: column; background-color: black;color: white;">
    <p style="position: relative; font-size: 40px; padding-top: 5vh;
    padding-bottom: 5vh;
    margin-left: auto;
    margin-right: auto;">
      Our Services</p>
    ...
    padding-right: 15px;
    font-size: 13px;">
      <div style="color: white; text-align: left; margin: auto;">
        <p style="">Our Services Can Be Classified Into 16 Major Categories. These Includes:<br><br>
  ...
  <div style="order: 3; height: 100vh;
    width: 100%;
    background-repeat: no-repeat;
    background-position: center;
    background-size: cover; display: flex; flex-direction: column; background-image: url(assets/media/about.png);">
    
      <div style="font-size: 15px; padding: 20vh 0 20vh 0;
    text-align: center;">
        <p style="text-transform: none; padding: 0.7vw 8.8vw 0.7vw 8.8vw;">
